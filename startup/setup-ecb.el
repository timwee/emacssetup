;;; ECB AND SEMANTIC ------------------------------------------
;; Load CEDET
(load-file (substitute-in-file-name "$EMACS_LIB/plugins/cedet-1.0pre6/common/cedet.el"))
...
;; ECB
(add-to-list 'load-path  (substitute-in-file-name "$EMACS_LIB/plugins/ecb-2.40"))
(require 'ecb) 
;(require 'ecb-autoloads)
(custom-set-variables
; '(ecb-options-version "2.32")
 '(ecb-source-path (quote ("~/projects/flightcaster/flightcaster-research")))
 '(ecb-tree-indent 1)
