...
;(load-file "$EMACS_LIB/plugins/misc/command_t.el")
;(global-set-key "\M-t" 'find-tag-file)

;;; ------------------------------------------------
;;; GNU Server
(load-file "$EMACS_LIB/plugins/misc/gnuserv.el")
...
;  (progn 
;    (load-file "$EMACS_LIB/plugins/misc/cua.el")
;    (require 'cua)
...
;    (load-file "$EMACS_LIB/plugins/misc/ido.el")))
;	(require 'ido)
(ido-mode t)
...
;(load-file "$EMACS_LIB/plugins/misc/project-local-variables.el")
;(load-file "$EMACS_LIB/plugins/misc/find-file-in-project.el")
...
;;; ------------------------------------------------
;;; icicles
;(add-to-list 'load-path (substitute-in-file-name "$EMACS_LIB/plugins/icicles"))
;(load-file "$EMACS_LIB/plugins/icicles/icicles.el")
;(icicle-mode t)

;;; ------------------------------------------------
;;; Remote Emacs buffer using Erlang 
;(add-to-list 'load-path (substitute-in-file-name "$EMACS_LIB/plugins/shbuf"))
;(require 'shbuf)
